...
| `docs/business/smartreturn-pro-super-admin-bootstrap-policy.md` | 초기 SUPER_ADMIN 계정 생성 정책, 비밀번호 보안 기준, bootstrap 실행 방식 후보를 정리하는 문서다. | SUPER_ADMIN bootstrap 스크립트 구현 전, 로그인/auth 구현 전 | 초기 관리자 bootstrap 구현 전 필수 |
...
| `docs/p0-product-master-management-api-verification-closeout.md` | P0 ��ǰ �� ��ǰ���ڵ� ���� API ���� ���� �Ϸ� ����� ����Ѵ�. | product/product_barcodes ���� API �ļ� ���� �Ǵ� ���� �μ��ΰ� �� | ���� |
